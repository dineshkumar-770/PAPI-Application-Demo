...
class ProfileImagesLastPage extends StatelessWidget {
  const ProfileImagesLastPage({super.key, required this.kIndex});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer(builder: (context, ref, child) {
        final allImages = ref.watch(lastPageProvider);
        //pp
        //cover
